...
public class SpecialStream {
    public static void main(String[] args) throws IOException {
        ...
        Stream<double[]> pythagoreanTriples2 = IntStream.rangeClosed(1, 100).boxed().flatMap(a -> IntStream.rangeClosed(a, 100).mapToObj(b -> new double[]{a, b, Math.sqrt(a * a + b * b)}).filter(m -> m[2] % 1 == 0));
