...
public class MyRSAEncrypt {  
    ...
    public static void genKeyPair(String filePath) {  
        ...
        try {  
            // �õ���Կ�ַ���  
            String publicKeyString = MyBase64.encode(publicKey.getEncoded());  
            // �õ�˽Կ�ַ���  
            String privateKeyString = MyBase64.encode(privateKey.getEncoded());  
            // ����Կ��д�뵽�ļ�  
    ...
    public static RSAPublicKey loadPublicKeyByStr(String publicKeyStr)  
            throws Exception {  
        try {  
            byte[] buffer = MyBase64.decode(publicKeyStr);  
    ...
    public static RSAPrivateKey loadPrivateKeyByStr(String privateKeyStr)  
            throws Exception {  
        try {  
            byte[] buffer = MyBase64.decode(privateKeyStr);  
